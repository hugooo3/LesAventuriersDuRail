...
public class Mappe 
{
	...
	public Mappe(ArrayList<Noeud> alNoeuds, ArrayList<Arete> alAretes, ArrayList<CarteDestination> alCartesDestination, 
				 ArrayList<CarteWagon> alCartesWagon, File imgMappe, int nbJoueurMin, int nbJoueurMax, int nbJoueurDoubleVoies, int nbWagonJoueur)
	{
