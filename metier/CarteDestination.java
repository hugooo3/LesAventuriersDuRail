...
public class CarteDestination {
	...
	public File getImgRecto() {
		return this.imgRecto;
	}

	public File getImgVerso() {
	...
	public void setImgRecto(File imgRecto) {
		this.imgRecto = imgRecto;
	}

	public void setImgVerso(File imgVerso) {
		this.imgVerso = imgVerso;
	}

	public String toString() {
		return noeud1.getNom() + " - " + noeud2.getNom() + " | " + this.points;
	}
}
